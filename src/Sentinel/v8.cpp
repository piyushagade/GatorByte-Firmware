#include "platform.h"
    ...
    /*
        ...
        -----------------------------------------------------------------------------------------
            ...
            9       |  Time tracker value           |  The value of start_timestamp[SELECTED_TIMERID]
    ...
    */
    ...
    #define FIRMWARE_MONTH 12
    #define FIRMWARE_DATE 20
    ...
    bool USE_PSM = false;
    bool SEND_ACK = true;
    bool TIMER_ENABLED[] = {false, false, false, true};
    ...
    uint8_t INTERVAL_BASE[4] = {15, 15, 15, 432};
    ...
    uint16_t start_timestamp[] = {millis() / 1000, millis() / 1000, millis() / 1000, millis() / 1000};
    ...
    */
    void memformat()
    {
        ...
        // Write base interval
        memwrite(location.sentinence_base, INTERVAL_BASE[0]);

        // Write interval multiplier
        memwrite(location.sentinence_multiplier, INTERVAL_MULTIPLIER[0]);
    ...
    */
    void memfetch()
    {
        ...
        // Base interval
        INTERVAL_BASE[0] = memread(location.sentinence_base);

        // Interval multiplier
        INTERVAL_MULTIPLIER[0] = memread(location.sentinence_multiplier);
                ...
                */
                ...
                if (selector < sizeof(options) / sizeof(options[0]))
                {
                    ...
                    if (INTERVAL_SET_MODE == 0)
                    {
                        ...
                        memwrite(location.sentinence_base, INTERVAL_BASE[SELECTED_TIMERID]);
            ...
            else if (x >= 50 && x <= 69)
            {
                ...
                */
                ...
                if (INTERVAL_SET_MODE == 0)
                {
                    ...
                    memwrite(location.sentinence_multiplier, INTERVAL_MULTIPLIER[SELECTED_TIMERID]);
